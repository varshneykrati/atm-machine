...
public class AtmMachineApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
        ...
        UserRegistration userRegistration2 = new UserRegistration("Shivam",localDate.now(),"9760281111",301577650820L,"shivam@gmail.com","shivam@7777","shivam@7777",UserRegistrationApproval.Inactive,new Address("415/8 New Market","Agra",283203,"Uttar Pradesh"),null);
        ...
        UserRegistration userRegistration5 = new UserRegistration("Ram",localDate.now(),"9960281111",678967896700L,"ram@gmail.com","ram@7700","ram@7700",UserRegistrationApproval.Inactive,new Address("415/8 Navi Mumbai","Mumbai",283203,"Maharastra"),null);
...
//Entering Card Detail of the user ->link with USER Registration
        ...
        CardDetails carddetail1 = new CardDetails(new BigInteger("123412341234"),new BigInteger("7890789078907890"),456,localDate.now(),CardType.Gold,25000.0,CardStatus.Inactive,2000.0,null,UserTotallyRegister.False,userRegistration2);
