...
//Entering user registration detail form with the -> address  -----
		...
		UserRegistration userRegistration1 = new UserRegistration("Krati Varshney",localDate.now(),"9760286311",678967896780L,"krativarshne@gmail.com","KVar@7777","KVar@7777","Inactive",address1,null);
		UserRegistration userRegistration2 = new UserRegistration("Shivam",localDate.now(),"9760281111",909067896789L,"shivam@gmail.com","shivam@7777","shivam@7777","Inactive",new Address("415/8 New Market","Agra",283203,"Uttar Pradesh"),null);
		UserRegistration userRegistration3 = new UserRegistration("Sidhi",localDate.now(),"9712121111",678967886789L,"sidhi@gmail.com","sidhi@7777","sidhi@7777","Inactive",new Address("415/8 Old Market","Agra",283203,"Madhya Pradesh"),null);
		UserRegistration userRegistration4 = new UserRegistration("Mansi",localDate.now(),"9760281156",679967896789L,"mansi@gmail.com","mansi@7777","mansi@7777","Inactive",new Address("905/8 New Market","Agra",283203,"Uttar Pradesh"),null);
		UserRegistration userRegistration5 = new UserRegistration("Ram",localDate.now(),"9960281111",678967896700L,"ram@gmail.com","ram@7700","ram@7700","Inactive",new Address("415/8 Navi Mumbai","Mumbai",283203,"Maharastra"),null);
...
//Entering Card Detail of the user -> link with USER Registration
		CardDetails carddetail1 = new CardDetails(new BigInteger("123412341234"),new BigInteger("7890789078907890"),456,localDate.now(),CardType.Silver,25000.0,CardStatus.Inactive,2000.0,null,UserTotallyRegister.False,userRegistration2);
...
// Now Add Transaction which is link to -> Address
		 TransactionDetails transaction1 = new TransactionDetails(carddetail1,new BigInteger("123412344321"),null,localDate.now(),500.0,null,null,null);
		 this.transactionRepository.save(transaction1);
		 TransactionDetails transaction2 = new TransactionDetails(carddetail1,new BigInteger("993412344321"),null,localDate.now(),1500.0,null,null,null);
		 this.transactionRepository.save(transaction2);
		 TransactionDetails transaction3 = new TransactionDetails(carddetail1,new BigInteger("553412344321"),null,localDate.now(),200.0,null,null,null);
		 this.transactionRepository.save(transaction3);
		 TransactionDetails transaction4 = new TransactionDetails(carddetail2,new BigInteger("123412344321"),null,localDate.now(),100.0,null,null,null);
		 this.transactionRepository.save(transaction4);
		 TransactionDetails transaction5 = new TransactionDetails(carddetail3,new BigInteger("123412344321"),null,localDate.now(),1200.0,null,null,null);
		 this.transactionRepository.save(transaction5);
		 TransactionDetails transaction6 = new TransactionDetails(carddetail3,new BigInteger("123412349921"),null,localDate.now(),400.0,null,null,null);
		 this.transactionRepository.save(transaction6);
		 TransactionDetails transaction7 = new TransactionDetails(carddetail4,new BigInteger("123412344329"),null,localDate.now(),5200.0,null,null,null);
...
///Now entering electricityBill which is link to -> CardDetail -> Transaction -> Vendors
		 ...
		 TransactionDetails transaction8 = new TransactionDetails(carddetail1,new BigInteger("126734582999"),null,localDate.now(),2000.0,electricityBill1,null,null);
		 ...
		 TransactionDetails transaction9 = new TransactionDetails(carddetail1,new BigInteger("126774582093"),null,localDate.now(),3000.0,electricityBill2,null,null);
		 ...
		 TransactionDetails transaction10 = new TransactionDetails(carddetail2,new BigInteger("106734582093"),null,localDate.now(),5000.0,electricityBill1,null,null);
...
//Now entering DTHBill which is link to -> CardDetail -> Transaction -> Vendors
		 ...
		 TransactionDetails transaction11 = new TransactionDetails(carddetail1,new BigInteger("126734582093"),null,localDate.now(),200.0,null,dthBill1,null);
		 ...
		 TransactionDetails transaction12 = new TransactionDetails(carddetail1,new BigInteger("126675423093"),null,localDate.now(),300.0,null,dthBill2,null);
		 ...
		 TransactionDetails transaction13 = new TransactionDetails(carddetail2,new BigInteger("126734512345"),null,localDate.now(),500.0,null,dthBill3,null);
